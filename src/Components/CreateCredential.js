...
const ip_port = "http://139.9.181.146:8080/";
...
const CreateCredential = () => {
    ...
    const createcredential = () => {
        ...
        // let percertificatepost = {
        //     signResult: signdata,
        //     issuerDID: certificate.issuerDID,
        //     templateName: certificate.templateName,
        //     certificateName: certificate.certificateName
        // }
        // axios.post(ip_port + 'getCertificateSignature',
        //     percertificatepost
        // ).then(res=>{
        //     console.log(res.data);
        //     setBlindcertificate(res.data, () => {
        //         console.log(blindcertificate);
        //         var FileSaver = require('file-saver');
        //
        ...
        //         let blob = new Blob([content], {type: "text/plain;charset=utf-8"});
        //         console.log(blindcertificate);
        //         FileSaver.saveAs(blob, "blindcertificate.txt");
        //         setCurrent(current + 1);
        //     });
        //
        // })
